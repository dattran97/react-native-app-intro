  ...
  render() {
    ...
    if (this.isToTintStatusBar()) {
      const statusBarColor =
        this.props.pageArray[0].statusBarColor ||
        this.props.pageArray[0].backgroundColor ||
        undefined;

      if (statusBarColor) {
        StatusBar.setBackgroundColor(
          this.shadeStatusBarColor(statusBarColor, -0.3),
          false
        );
      }
    }
      ...
      <View>
        ...
        <Swiper
          ...
          onMomentumScrollEnd={(e, state) => {
            if (this.isToTintStatusBar()) {
              const statusBarColor =
                this.props.pageArray[state.index].statusBarColor ||
